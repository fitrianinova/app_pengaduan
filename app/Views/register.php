		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">From Registrasi Aplikasi Pengaduan Masyarakat Desa Cisantana</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				...
				<div class="form-group">
		      			<input name="txtTelp" type="text" class="form-control" placeholder="No Telp" required>
                    </div>
	            <div class="form-group">
